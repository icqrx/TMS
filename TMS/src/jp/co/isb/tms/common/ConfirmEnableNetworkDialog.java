...
public class ConfirmEnableNetworkDialog{
	private Context mContext;
	private Dialog dialog;
	private Button no, yes;
	
	public ConfirmEnableNetworkDialog(Context context){
		mContext = context;
		...
		message.setText(mContext.getResources().getString(R.string.text_wifi));
