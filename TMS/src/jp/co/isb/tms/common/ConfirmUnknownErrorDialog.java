...
public class ConfirmUnknownErrorDialog {
	private Context mContext;
	private Dialog dialog;
	private Button no, yes;
	
	public ConfirmUnknownErrorDialog(Context context){
		mContext = context;
		...
		message.setText(mContext.getResources().getString(R.string.text_unknown_error));
